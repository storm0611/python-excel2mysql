...
client = openrouteservice.Client(
    '5b3ce3597851110001cf62482170852fca824c29877a6fa8a0f95c2b')


n_next = 50

data = pd.read_excel('dati1.xlsx', sheet_name='Rubr', nrows=n_next+1)
...
######################
# Resolvs the routing problem / Risolve problema di Routing
######################
